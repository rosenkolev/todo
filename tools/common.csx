...
public static partial class MM
{
    public static void WriteLine(string message, LogLevel logLevel = LogLevel.Message)
    {
        ...
        switch (level)
        {
            ...
            case 4: Console.ForegroundColor = ConsoleColor.DarkGray; break; // Debug
            default: return;
        }
    ...
    public static void RemoveFiles(params string[] pathToFiles)
    {
    ...
    public static void CopyFilesRecursively(string source, string target)
    {
        ...
        if (sourceDir.Exists)
        {
            ...
            CopyFilesRecursively(sourceDir, new DirectoryInfo(target));
        }
    }
